...
app.post('/api/register/options', async (req, res) => {
  try {
    ...
    const existingCredentials = await webauthn.getStorageAdapter()
...
app.post('/api/authenticate/options', async (req, res) => {
  try {
    ...
    const user = await webauthn.getStorageAdapter()
...
app.post('/api/authenticate/verify', async (req, res) => {
  try {
    ...
    const credential = await webauthn.getStorageAdapter()
      .credentials.findById(req.body.id);
